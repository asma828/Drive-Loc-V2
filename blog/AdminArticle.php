...
<body class="bg-gray-100">
    ...
    <div class="fixed w-64 h-full bg-black text-white p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="AdminArticle.php" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg bg-white text-black">
...
<div class="flex">
        ...
        <div class="ml-64 flex-1 p-8">
            <h2 class="text-3xl font-light mb-6">Gestion des Article</h2>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-sm font-medium text-gray-500">Theme</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <?php foreach($articles as $arr): ?>
                            <td class="h-8 w-8 rounded-full mr-3">
                                <img src="<?= htmlspecialchars( $arr['image']) ?>" alt="">
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    
                                    <div>
                                        <div class="font-medium"><?= htmlspecialchars( $arr['name']) ?></div>
                                        
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4"><?= htmlspecialchars( $arr['title']) ?></td>
                            <td class="px-6 py-4">
                                
                                <div class="text-sm text-gray-500"><?= htmlspecialchars( $arr['theme']) ?></div>
                            </td>
                            
                            <td class="px-6 py-4">
                            
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                <?= htmlspecialchars( $arr['status']) ?>
                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex space-x-3">
                                    ...
                                    <a href="approuveArticle.php?id=<?php echo $arr['id_article'] ?>" class="text-green-600 hover:text-green-900">
                                        <i class="fas fa-check"></i>
                                    </a>
                                    <a href="denyArticle.php?id=<?php echo $arr['id_article'] ?>" class="text-red-600 hover:text-red-900">
