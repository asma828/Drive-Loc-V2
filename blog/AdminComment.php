...
$Commente=$comments->afficheComment();
...
<body class="bg-gray-100">
    ...
    <div class="fixed w-64 h-full bg-black text-white p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="AdminComment.php" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg bg-white text-black">
    ...
    <div class="flex">
        ...
        <div class="ml-64 flex-1 p-8">
            <h2 class="text-3xl font-light mb-6">Gestion des Article Commentaires</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Review Card -->
    <?php foreach($Commente as $com):?>
                <div class="bg-white rounded-lg shadow">
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-4">
                            <div class="flex items-center">
                                <img src="<?= htmlspecialchars($com['image'])?>" class="h-10 w-10 rounded-full mr-3">
                                <div>
                                    <div class="font-medium"><?= htmlspecialchars($com['name'])?></div>
                        ...
                        <div class="mb-4">
                            <div class="font-medium mb-1"><?= htmlspecialchars($com['title'])?></div>
                            <p class="text-gray-600"><?= htmlspecialchars($com['content'])?></p>
                        </div>
                        <div class="flex justify-end space-x-2">
                            <button class="text-gray-600 hover:text-gray-900">
                                <i class="fas fa-eye"></i>
                            </button>
                            <a href="deleteComment.php?id=<?php echo $com['id_comment']?>" class="text-red-600 hover:text-red-900">
